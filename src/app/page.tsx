  ...
  return (
    <div className="p-8 bg-[#FDF5E6] min-h-screen font-sans text-[#3E2723]">
      <header className="mb-10 flex justify-between items-center">
        ...
        <Link href="/admin/importar" className="flex items-center bg-[#3E2723] text-white px-6 py-3 rounded-full font-bold hover:bg-black transition-all">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="bg-white p-8 rounded-3xl shadow-sm border-b-8 border-amber-400">
          ...
          <p className="text-gray-500 uppercase text-xs font-bold tracking-widest">Ventas Hoy</p>
        ...
        <div className="bg-white p-8 rounded-3xl shadow-sm border-b-8 border-green-400">
          ...
          <p className="text-gray-500 uppercase text-xs font-bold tracking-widest">Margen Bruto</p>
        ...
        <div className="bg-white p-8 rounded-3xl shadow-sm border-b-8 border-red-400">
          ...
          <p className="text-gray-500 uppercase text-xs font-bold tracking-widest">Stock Crítico</p>
          <p className="text-4xl font-black italic">S/D</p>
        </div>
      </div>
      
      <div className="mt-12 bg-white p-10 rounded-[40px] border border-amber-100 shadow-inner">
        <h2 className="text-2xl font-bold mb-4 flex items-center">📊 Actividad Reciente</h2>
        <p className="text-gray-400 italic font-medium text-lg">Esperando carga de datos desde Barcelona...</p>
      </div>
    </div>
  );
}
